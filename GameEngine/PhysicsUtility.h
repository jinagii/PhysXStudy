...
static std::vector<physx::PxRigidActor*> GetPxRigidActorVector(physx::PxScene* pScene, physx::PxActorTypeFlags flag);
static physx::PxRigidActor* GetPxRigidActor(std::vector<physx::PxRigidActor*> actors, int index);
...
std::vector<physx::PxRigidActor*> GetPxRigidActorVector(physx::PxScene* pScene, physx::PxActorTypeFlags flag)
{
   uint32_t _actorNum = pScene->getNbActors(flag);
   std::vector<physx::PxRigidActor*> _actor_V(_actorNum);
   pScene->getActors(flag, reinterpret_cast<physx::PxActor**>(_actor_V.data()), _actorNum);

   return _actor_V;
}

physx::PxRigidActor* GetPxRigidActor(std::vector<physx::PxRigidActor*> actors, int index)
{
